...
namespace ACS
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        public static string connectionString = App.ConCnString;
        ...
        public static bool TabExists(string TableName)
        {
            ...
            //string strsql = "SELECT count(*) FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[" + TableName + "]') AND DType in (N'U')";
            object obj = GetSingle(strsql);
            int cmdresult;
            if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
            {
        ...
        {
            SqlConnection conn = new SqlConnection(connectionString);//创建数据库连接对象
            conn.Open();//打开数据库连接
